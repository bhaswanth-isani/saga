...
class _EpubViewerState extends State<EpubViewer> {
  ...
  loadBook() async {
    ...
    String manager = 'continuous';
    String flow = 'paginated';
    String spread = displaySettings.spread.name;
    bool snap = true;
    bool allowScripted = true;
    String cfi = widget.initialCfi ?? "";
    String direction = 'ltr';

    bool useCustomSwipe = false;

    String? backgroundColor = widget.displaySettings?.theme?.background.toHex();
    String? foregroundColor = widget.displaySettings?.theme?.foreground.toHex();
  ...
  Widget build(BuildContext context) {
    return InAppWebView(
      ...
      key: webViewKey,
      initialFile: 'assets/html/swipe.html',
      initialSettings: settings..disableVerticalScroll = true,
